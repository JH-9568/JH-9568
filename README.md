...
-  **데이터 기반 기능 구현**
  - Whisper, Gemini, LangChain 등 AI 모델 연동
  - Redis Pub/Sub을 이용한 실시간 이벤트 처리
---
...
![Riverpod](https://img.shields.io/badge/Riverpod-0F9D58?style=flat&logo=flutter&logoColor=white)
![GoRouter](https://img.shields.io/badge/GoRouter-4285F4?style=flat&logo=flutter&logoColor=white)
